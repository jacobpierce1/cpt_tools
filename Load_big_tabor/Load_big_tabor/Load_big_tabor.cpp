	...
	int wminus_length, int wplus_length, int wc_length )
{
	...
	//double wminus = 1571; ////wminus before the magnet quenched : 1600.0;
	//
	//double wplus = 673429.2; 
	////diff. wplus values from before the magnet quenched : //388686.5;//828458.5;// 760196;// 830196.1; // 656250.0;//388686.5; // 130In //646445.9 135Te// 150Ce 1164702.5; // 1118649.8;// // //133Cs = 656250.0 //142Cs = 614447.6
	//double wc = 675000.3; 
	////diff. wc values from before the magnet quenched : //829658; // 831946.0; //939200 //130I648038.4 135Te // 150Ce 1166293.3; // 1120240.8;//1797579.0;// 1181999.3;// 1121410.2;// 130In = 672935.5; // 616040.4; // 657844.5;// 133Cs = 657844.5; //// 142Cs = 616040.4

	//double wminus_phase = -160;//-140.0;// -110.0;// 30.0;
	//double wplus_phase = 0.0;
	//double wc_phase = 0.0;

	//double wminus_amp = 0.0035;//0.0045;// 0.0035;// 0.003;// 0.0075
	//double wplus_amp = 0.22	;//0.22;  //0.11
	//double wc_amp = 0.5; // don't change

	//int wminus_loops = 1; // don't change
	//int wplus_loops =  103;//103;//32;//56;//120;// 133Cs = 100;
	//int wc_loops = 228; //215;//132;//282;// 212;// 133Cs = 210
	// 
	//int wminus_length = 3;// 3 ; // 2
	//int wplus_length = 1;
	//int wc_length = 1; // don't change
	//
	//int tacc = 234120 ;// 220040;// 234075; // 240023;// 250063; // 190318;// 148010;// 60008 18500; 
	// time in us
...

	{
		...
		//Open File
		wfstream myfil;
		myfil.open("C:/Users/cpt/Box Sync/piicr_2018/DataRecord_july2018_re-energized_magnet.txt", fstream::app);
		/*
		// Time
