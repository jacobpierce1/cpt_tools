...
int load_tabor( TaborSettings settings )
{
    ...
    double wc_phase = settings.wc_phase;

    double wminus_amp = settings.wminus_amp;
    double wplus_amp = settings.wplus_amp;
    double wc_amp = settings.wc_amp;
	

    int wminus_loops = settings.wminus_loops;
    int wplus_loops = settings.wplus_loops;
    int wc_loops = settings.wc_loops;

    int wminus_length = settings.wminus_length;
    int wplus_length = settings.wplus_length;
    int wc_length = settings.wc_length;

    int tacc = settings.tacc;
